---
name: Improve Tag Diversity (MuFun)
about: Track work to improve diversity & precision of MuFun-generated tags
title: "Improve Tag Diversity and Precision (MuFun)"
...
- Relevant files:
  - scripts/tagger.py (MuFun flow)
  - include/mufun_loader.py (HF loader)
  - scripts/moods.py (extract_clean_tags)
  - config/config.json (hf_model_path, use_audio, gen_*)
